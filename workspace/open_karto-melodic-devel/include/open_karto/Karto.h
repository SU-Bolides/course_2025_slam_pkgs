  ...
  public:
    ...
    static LaserRangeFinder* CreateLaserRangeFinder(LaserRangeFinderType type, const Name& rName)
    {
      ...
      switch (type)
      {
        ...
        {
          pLrf = new LaserRangeFinder((rName.GetName() != "") ? rName : Name("A2M12"));

          // Sensing range is 80 meters.
          pLrf->m_pMinimumRange->SetValue(0.2);
          pLrf->m_pMaximumRange->SetValue(12.0);
          ...
          pLrf->m_pAngularResolution->SetValue(math::DegreesToRadians(0.225));
