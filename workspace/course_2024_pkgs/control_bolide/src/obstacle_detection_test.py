...
class ObstacleDetection:
    ...
    def __init__(self):
        ...
        self.occup_grid_sub = rospy.Subscriber("ocucpancy_grid", OccupancyGrid, self.occup_grid, queue_size=1)
        self.current_waypoint_pub = rospy.Publisher("move_around", Marker, queue_size=10)
        ...
        for i in range(-margin, margin + 1):  # for the margin, check
            ...
            for cell in self.utils.traverse_grid(cell_a_margin, cell_b_margin):
                ...
                try:
                    ...
                    rospy.loginfo(f"Sampled point is out of bounds: {cell}")
                    return True
        return False
    ...
    def check_for_obstacles(self):
        ...
        if self.check_collision(current_pos, goal_pos, margin=MARGIN):
            ...
            for shift in shifts:
                ...
                if not self.check_collision(current_pos, new_goal, margin=int(1.5 * MARGIN)):
                    ...
                    rospy.loginfo("Found condition 1")
                    break
            ...
            if not found:
                ...
                for shift in shifts:
                    ...
                    if not self.check_collision(current_pos, new_goal, margin=int(1.5 * MARGIN)):
                        ...
                        found = True
                        path_local.append(target)
                        rospy.loginfo("Found condition 2")
                        break
            ...
            if not found:
                ...
                for shift in shifts:
                    ...
                    if not self.check_collision_loose(current_pos, new_goal, margin=MARGIN):
                        ...
                        found = True
                        path_local.append(target)
                        rospy.loginfo("Found condition 3")
                        break
        ...
        if target:
            ...
            rospy.loginfo("Allah take the wheel IDK what to do")
            self.drive_to_target_stanley()
