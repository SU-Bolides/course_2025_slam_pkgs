...
class CameraProcess(Node):
    def __init__(self):
        ...
        self.get_logger().info("[INFO] -- Initializing the camera process data node")
        ...
        self.sub = self.create_subscription(Image, '/raw_image_data', self.callback_image)
    ...
    def calibrate_from_existing_images(self):
        ...
        capture_folder = "/home/voiture/COURSE_2025_SLAM_PKGS/workspace/src/perception_bolide/perception_bolide/calibration_captures"
